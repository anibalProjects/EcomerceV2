...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::post('/actualizar-preferencias', [CookiePersonalizacion::class, 'update']);
    Route::get('/obtener-preferencias', [CookiePersonalizacion::class, 'getPreferenciasApi']);
});

Route::post('/login', [AuthController::class, 'login'])->name('login.post');
Route::post('/register', [AuthController::class, 'store'])->name('register.post');

// Rutas antiguas para compatibilidad si fuera necesario (opcional)

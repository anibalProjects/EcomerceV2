            ...
            <div class="col-md-8 offset-md-2">
                ...
                @auth
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <p><strong>Tema:</strong> <span id="current-tema">{{ Auth::user()->getPreference('tema', 'claro') }}</span></p>
                            <p><strong>Moneda:</strong> <span id="current-moneda">{{ Auth::user()->getPreference('moneda', 'EUR') }}</span></p>
                            <p><strong>Paginación:</strong> <span id="current-paginacion">{{ Auth::user()->getPreference('paginacion', 12) }}</span></p>
                        </div>
                    </div>
                            ...
                            <form id="form-moneda" class="mb-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="moneda" id="moneda-select" class="form-control">
                                        <option value="EUR" @selected(Auth::user()->getPreference('moneda', 'EUR') == 'EUR')>EUR</option>
                                        <option value="USD" @selected(Auth::user()->getPreference('moneda', 'EUR') == 'USD')>USD</option>
                                        <option value="GBP" @selected(Auth::user()->getPreference('moneda', 'EUR') == 'GBP')>GBP</option>
                                    </select>
                                </div>
                            ...
                            <form id="form-paginacion">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="paginacion" id="paginacion-select" class="form-control">
                                        ...
                                        <option value="12" @selected(Auth::user()->getPreference('paginacion', 12) == 12)>12</option>
                                        <option value="24" @selected(Auth::user()->getPreference('paginacion', 12) == 24)>24</option>
                                    </select>
                                </div>

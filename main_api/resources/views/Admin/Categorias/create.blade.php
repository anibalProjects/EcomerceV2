...
<style>
    ...
    .cart-btn { border: 1px solid var(--gold); color: var(--gold); background: transparent; border-radius: 8px; }
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="form-section">
                <h2 class="card-title mb-4 text-center"><i class="bi bi-plus-circle me-2"></i>Crear Nueva Categoría</h2>
